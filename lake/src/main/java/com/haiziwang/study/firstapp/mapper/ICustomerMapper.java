...
public interface ICustomerMapper {
	...
	public List<Customer> queryWithPage(@Param("query") HashMap<String,String> query,@Param("page") PageCond pageCond);

	public Customer find(@Param("custId") long custId);
	
	public int update(@Param("cust") Customer cust);
	
	public void updateStatus(@Param("custId") Long custId,@Param("status") String status);
